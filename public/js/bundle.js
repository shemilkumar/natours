...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2hlbWlsIiwiYSI6ImNsZGszemE4ZzBoM3czbmxndjN2MzZyeHAifQ.G1Yfj0FJuYB0zzLuQyabpw';
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "".concat(baseUrl).concat(api, "/users/login"),
            data: {
              email: email,
              password: password
            }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MWuwBSGpYK5WTMoLmSWouGpjoyCSTx54BXnyNKs0GAf5Zgn4hnbzBEDuA51qHktgB1kV04IgLHuOAfdZ1SWNYc400WkAa2Wdr');
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var passwordCurrent, passwordNew, passwordNewConfirm;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          ...
          passwordNewConfirm = document.getElementById('password-confirm').value; // console.log({ passwordCurrent, password, passwordConfirm });
          _context.next = 7;
